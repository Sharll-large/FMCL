...
lang1 = Lang(
    ...
    n2w={
        ...
        "Settings.Lang.Tips.Restart": "Language changed successfully! Please restart the program.",
        "Settings.Launch.GUI.Boost": "Enable JVM Boost Args",
