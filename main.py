...
def main():
    ...
    print(co.Fore.MAGENTA + "##" + co.Fore.WHITE + "####" + co.Fore.CYAN + "##" + co.Style.RESET_ALL + "\t" + "Operating system:\t" + platform.system() + "(RAW)/" + Core.System.SystemAndArch.system())
    print(co.Fore.MAGENTA + "##" + co.Fore.WHITE + "####" + co.Fore.CYAN + "##" + co.Style.RESET_ALL + "\t" + "System Architect:\t" + platform.machine() + "(RAW)/" + Core.System.SystemAndArch.arch())
    ...
    while True:
        ...
        if command == "cd" and len(args) >= 1:
            ...
            print("launch <version>:\tLaunch minecraft.")
            print("cdjava <path>:\tChange java runtime path.")
            print("rename <name>:\tChange your player name.")
            print("cd <path>:\tChange .minecraft path.")
            print("scan:\tPrint all the versions are installed.")
        elif command == "exit":
            break
