...
import FMCLCore.System.CoreSystemInformation
...
def get_task(version_name: str, version: str, mcpath: str):
    ...
    # create game folder
    FMCLCore.System.CoreMakeFolderTask.make_long_dir(os.path.join(mcpath, "versions", version_name))
    ...
    for i in ver_json["libraries"]:
        if "downloads" in i:
            ...
            elif ("classifiers" in i["downloads"]) and "natives-" + FMCLCore.System.CoreSystemInformation.system() in \
    ...
    # assets
    FMCLCore.System.CoreMakeFolderTask.make_long_dir(os.path.join(mcpath, "assets", "indexes"))
    FMCLCore.System.CoreMakeFolderTask.make_long_dir(os.path.join(mcpath, "assets", "objects"))
    ...
    # log4j config
    FMCLCore.System.CoreMakeFolderTask.make_long_dir(f"{mcpath}\\versions\\{version_name}")
...
def download(ver_name: str, version: str, mcpath: str, threads: int):
    ...
    for i in nativesjar:
        ...
        FMCLCore.System.CoreMakeFolderTask.make_long_dir(os.path.join(
            os.path.realpath(mcpath), "versions", ver_name, "natives-" + FMCLCore.System.SystemAndArch.system() + "-" + FMCLCore.System.SystemAndArch.arch()))
